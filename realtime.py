...
model.eval()
model.load_pretrained('pretrained/99_model.pt')
CLASSES = get_classes() 
COLORS = get_colors() 
...
while cap.isOpened(): 
    ...
    # ============================================
    if len(bboxes) > 0:
        nms_threshold = 0.4  # Adjust this: 0.3=stricter, 0.5=looser
        keep = nms(bboxes, probas, nms_threshold)
...
logger.realtime("Camera released and detection stopped.")